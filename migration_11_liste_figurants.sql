-- Migration 11 : ajouter "liste_figurants" comme type de document importable pour un film
...
alter table film_documents add constraint film_documents_type_document_check
  check (type_document in ('bible', 'pdt', 'scenario', 'depouillement', 'liste_figurants'));
